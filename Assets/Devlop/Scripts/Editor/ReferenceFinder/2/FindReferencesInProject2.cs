...
//source url: https://github.com/networm/FindReferencesInProject2/blob/master/FindReferencesInProject2.cs
public static class FindReferencesInProject2
{
    private const string MenuItemName = "Assets/Find References In Project2 %#&f";
