...
namespace NoiseCrimeStudios.Editor.Internal
{
    ...
    public static class InternalScreenShotting
    {
        ...
        public static void SetMainWindowSizeSmall()
        {
            ...
            var screenShotsType = assembly.GetType("UnityEditor.MainView,UnityEditor", true);
            var mainView = Resources.FindObjectsOfTypeAll(screenShotsType)[0] as EditorWindow;

            mainView.position = new Rect(0f, 0f, 1024f, 768f);
            return;
        ...
        public static void ScreenGameViewContent()
        {
            ...
            ScreenCapture.CaptureScreenshot(GetUniquePathForName("screenCapture"), ScreenCapture.StereoScreenCaptureMode.BothEyes);
        }
